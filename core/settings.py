...
SECRET_KEY = 'django-insecure-m#z6yl6kn%%y7=h(iq=ffty$ci*%wppdy1fxbvsuf#=hnzhkl0'
...
# This will overwrite the default django authentication to use our created one
